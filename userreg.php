...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // SQL文を準備（UIDを含むように修正）
    $sql = "INSERT INTO Account (UID, LastName, LastNameKana, FirstName, FirstNameKana, UserName, Birthdate, Phone, Email, Pass)
    VALUES (:uid, :last_name, :last_name_kana, :first_name, :first_name_kana, :username, :birthdate, :phone, :email, :pass)";
